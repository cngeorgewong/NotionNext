...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'd9092e1daca648349dcd622562fafc11',
  ...
  AUTHOR: 'georgewong', // 作者
  BIO: '三尺微命，一介凡人。', // 作者简介
  LINK: 'https://wong.ink', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '2553061@qq.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/cngeorgewong', // 你的github个人主页
